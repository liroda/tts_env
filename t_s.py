...
class ToneSandhi():
    ...
    def _neural_sandhi(self, word: str, pos: str,
        ...
        elif len(word) >= 1 and word[-1] in "得":
            finals[-1] = finals[-1][:-1] + "5"
        # e.g. 走了, 看着, 去过
    ...
    def _three_sandhi(self, word: str, finals: List[str]) -> List[str]:
        if len(word) == 2 and self._all_tone_three(finals):
            #print ("in _three_sandhi",word,finals)
        ...
        # split idiom into two words who's length is 2
            ...
            for sub in finals_list:
                if self._all_tone_three(sub) and sub:
                    sub[0] = sub[0][:-1] + "2"
                finals += sub
    ...
    def _merge_yi(self, seg: List[Tuple[str, str]]) -> List[Tuple[str, str]]:
        ...
        # function 2
        for i, (word, pos) in enumerate(seg):
            if new_seg and new_seg[-1][0] == "一" and re.match(r'[\u4e00-\u9fa5]+$',word):
    ...
    def pre_merge_for_modify(
        ...
        try:
            ...
            print ("pre_merge_for_modify warning {}".format(traceback.format_exc()))
        return seg
    ...
    def modified_tone(self, word: str, pos: str,
        ...
        try:
            ...
            print ("modified tone warning {}".format(traceback.format_exc()))
        return finals
